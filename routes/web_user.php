...
Route::middleware(['RedirectIfAuthenticated'])->group(function () {
    ...
    Route::get('candidature-soumise', [CandidatController::class, 'candidatureSoumise'])->name('candidature_soumise');
    ...
    // Route pour le CV
    Route::get('/candidat/{id}/cv', [CandidatController::class, 'afficherCV'])->name('candidat.cv');
});

// Routes pour les formations
Route::prefix('formations')->name('formations.')->middleware(['auth:personnel'])->group(function() {
