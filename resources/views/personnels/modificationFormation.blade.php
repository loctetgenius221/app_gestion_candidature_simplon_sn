      ...
      <div class="col">
        ...
        <form action="{{ route('CreationFomationTraitement') }}" method="POST" class="form-group"> 
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="debouches" name="debouches" value="{{ old('debouches') }}">
          </div>
          <div class="form-group">
            <label for="critere_de_validation" class="form-label">Critères de validation</label>
            <input type="text" class="form-control" id="critere_de_validation" name="critere_de_validation" value="{{ old('critere_de_validation') }}">
          </div>
          <div class="form-group">
            <label for="date_de_debut" class="form-label">Date de début de la formation</label>
            <input type="date" class="form-control" id="date_de_debut" name="date_de_debut" value="{{ old('date_de_debut') }}">
          </div>
          <div class="form-group">
            <label for="date_de_fin" class="form-label">Date de fin de la formation</label>
            <input type="date" class="form-control" id="date_de_fin" name="date_de_fin" value="{{ old('date_de_fin') }}">
          </div>
          <br>
          <div class="form-group">
            <label for="statut" class="form-label">Statut de la formation</label>
            <select name="statut" class="form-control" required>
                ...
                <option value="a venir" {{ old('statut') == 'a venir' ? 'selected' : '' }}>À venir</option>
            </select>
          </div>
          <div class="form-group">
            ...
            <select name="personnel_id" class="form-control" required>
                @foreach($personnels as $personnel)
                    <option value="{{ $personnel->id }}" {{ old('personnel_id') == $personnel->id ? 'selected' : '' }}>{{ $personnel->prenom }}</option>
                @endforeach
            </select>
          </div>
