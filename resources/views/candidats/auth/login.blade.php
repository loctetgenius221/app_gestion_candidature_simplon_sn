{{-- <form method="POST" action="{{ route('candidat-login') }}" class="form-group">
                ...
                <div class="formulaire">
                    ...
                    <form method="POST" action="{{ route('candidat-login') }}"  class="form-group  registration-form" enctype="multipart/form-data">
                        @csrf
                            <h2>Connexion</h2>
                            ...
                            <input type="password" id="password" name="mot_de_passe" required placeholder="Saisir mot de passe">
